...
// 摆件媒体：静态图由浏览器转为固定 RGB565；GIF 保留原文件。
#define ORNAMENT_GIF_MAX_BYTES 1400000UL
#define ORNAMENT_SOURCE_MAX_BYTES (20UL * 1024UL * 1024UL)
#define ORNAMENT_GIF_MAX_FRAMES 500
#define ORNAMENT_GIF_MIN_FRAME_MS 67UL
